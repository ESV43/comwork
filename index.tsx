...
Output ONLY the final image. Do not add any text or annotations to the image itself.`;
            ...
            // **THE FIX**: Use a specific, capable multimodal model for this task.
            // 'gemini-1.5-flash' is a good balance of capability and generous rate limits.
            ...
            if (imagePart && imagePart.inlineData) {
                ...
                throw new Error("The AI model responded, but did not return a valid image. Please try again.");
            }
            ...
            if (error.message && (error.message.includes('"code":429') || error.message.includes('RESOURCE_EXHAUSTED'))) {
                errorMessage = "Model Sheet generation failed due to API rate limits (Error 429). You may have exceeded your free tier usage. Please wait a minute and try again.";
            }
            alert(errorMessage);
